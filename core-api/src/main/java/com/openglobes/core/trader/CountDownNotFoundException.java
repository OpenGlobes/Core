 ...
 * @author chenh
 */
public class CountDownNotFoundException extends EngineException{
    
    public CountDownNotFoundException(String message) {
        super(message);
    }

    public CountDownNotFoundException(String message, Throwable cause) {
        super(message, cause);
    }

    public CountDownNotFoundException(Throwable cause) {
        super(cause);
    }
