...
public interface ExceptionHandler<T> {
     ...
     * {@link BatchEventProcessor} then it should throw a
     * {@link RuntimeException}.</p>
     *
     * @param ex       the exception that propagated from the
     *                 {@link EventHandler}.
     * @param sequence of the event which cause the exception.
     * @param event    being processed when the exception occurred. This can be
     *                 null.
     */
    ...
    /**
     * Callback to notify of an exception during
     * {@link LifecycleAware#onShutdown()}
     *
