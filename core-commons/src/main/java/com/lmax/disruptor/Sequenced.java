...
public interface Sequenced {
     ...
     * event producing. Using batch producing requires a little care and some
     * math.
     * <pre>
     * int n = 10;
    ...
    /**
     * Attempt to claim the next event in sequence for publishing. Will return
     * the number of the slot if there is at least <code>requiredCapacity</code>
     * slots available.
     *
     * @return the claimed sequence value
     *
    ...
    /**
     * Attempt to claim the next n events in sequence for publishing. Will
     * return the highest numbered slot if there is at least
     * <code>requiredCapacity</code> slots available. Have a look at
